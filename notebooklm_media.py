...
DEFAULT_VIDEO_FOCUS = (
    "Create a cinematic story about real people navigating a world that is changing faster "
    "than anyone expected. This is not a systems overview. It is a human story told through "
    "the lens of today's biggest developments. Every frame should make a viewer feel something "
    "-- curiosity, urgency, wonder, or unease. Push Veo 3 visual quality to its maximum. "
    "\n\n"
    "THE HUMAN RULE: Every scene needs a human anchor. A hand reaching for a phone. A face "
    "lit by a laptop screen at 2am. Someone walking through an empty office. A crowd staring "
    "up at a screen. Technology is always the backdrop, never the subject. The subject is what "
    "this means for a real person watching this video over breakfast. "
    "\n\n"
    "STRUCTURE & NARRATIVE: "
    ...
    "Act 1 -- The Stakes (0:15-1:30): The story that affects everyone. Show the human cost or "
    "opportunity first, then the scale. Wide establishing shots, then find the person in the "
    "frame. Build tension through faces and reactions, not just systems. "
    "Act 2 -- The Shift (1:30-3:00): The technology story. But tell it through what it unlocks "
    "for people, not what the specs are. Show someone using it, being affected by it, building "
    "with it. Shift palette from warm to cool. Data visualizations should feel alive -- flowing, "
    "organic, not clinical. "
    "Act 3 -- The Collision (3:00-4:00): Where these forces meet in someone's daily life. How "
    "does the geopolitical event affect the developer? How does the new AI tool change what "
    "the analyst does tomorrow? Visual juxtaposition between both worlds. Build to a question, "
    "not a conclusion. "
    "Close (4:00-4:30): End on a single human image. Someone looking out a window. A hand "
    "closing a laptop. A city skyline at dawn. Hold the frame. Let it breathe. "
    "\n\n"
    "VISUAL DIRECTION PER SCENE: "
    "Stakes scenes: Find the human first, then reveal the scale around them. A person watching "
    "news on a phone, then pull back to show the trading floor behind them. Warm amber-red "
    "color grading. Handheld camera for immediacy and intimacy. "
    "Shift scenes: People interacting with technology -- fingers on keyboards, screens "
    "reflecting in glasses, a developer leaning back from a monitor. Data center interiors "
    "with a person walking through, dwarfed by the scale. Cool blue-cyan grading. Smooth dolly "
    "movements for wonder. "
    "Collision scenes: Split-screen or morphing transitions with human continuity -- a hand "
    "swiping a phone dissolves into a hand on a control panel. Same person, different world. "
    "Closing shot: Intimate human moment. Quiet. Still. "
    "\n\n"
    "CINEMATOGRAPHY: "
    "Lighting: Golden hour warmth for human moments, cool fluorescent for tech interiors, "
    ...
    "Color palette: warm amber (stakes), cool blue (shift), mixed (collision), quiet desaturated "
    "(closing). "
    "\n\n"
    ...
    "something incredible, let the wonder show. When describing something concerning, do not "
    "hide the concern. This is not a newscast -- it is a story. "
    "\n\n"
    ...
    "Screen reflections on faces and polished surfaces. Coffee cups, phone notifications, "
    "the glow of a laptop in a dark room. "
    "Depth particles: fog layers, atmospheric haze, bokeh light points. "
    "Material textures: brushed metal, polished glass, rough concrete, wet asphalt."
)
